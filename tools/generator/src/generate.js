...
module.exports = function (argv) {
 ...
 updateBuildFile('src/app/BUILD.bazel', {
 ...
 updateBuildFile('src/BUILD.bazel', {
  mappedFeatureList: FEATURES.map(_feature => `"src/app/${_feature.path}/${_feature.path}.module.ngfactory"`)
 });

 // Update routing module with routes definition
 updateRoutesInNgModule(`src/app/app-routing.module.ts`, {
  routes: FEATURES.map(_feature => _feature.path)
 });

 // Update src/app/app.component.html with links to the new generated modules
 updateRoutesInAppComponentHtml('src/app/app.component.html', {
  features: FEATURES
 });
}